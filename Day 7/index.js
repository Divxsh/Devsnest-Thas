...
//   console.log(library[i].author); // Bill Gates, The Road Ahead, true
//   console.log(library[i].title); // Steve Jobs, Walter Isaacson, true
//   console.log(library[i].readingStatus); // Suzanne Collins, Mockingjay: The Final Book of The Hunger Games, false
// }
